...
const SignUp = () => {
    const districts = ['Chennai', 'Coimbatore', 'Erode', 'Madurai', 'Salem', 'Tiruchirappalli', 'Tiruppur', 'Vellore', 
    'Virudhunagar', 'Tirunelveli', 'Thoothukudi', 'Thanjavur', 'Dindigul', 'Tiruvannamalai', 'Tenkasi', 'Kancheepuram', 
    'Tirupathur', 'Krishnagiri', 'Cuddalore', 'Kallakurichi', 'Viluppuram', 'Ranipet', 'Nagercoil', 'Namakkal', 'Sivagangai', 
    'Karur', 'Nagapattinam', 'Perambalur', 'Pudukkottai', 'Ariyalur', 'Nilgiris', 'Dharmapuri', 'Theni', 'Tiruvarur', 'Ramanathapuram', 'Thiruvarur'];
            ...
            <form className=" w-[550px] bg-white shadow-xl ">
                ...
                <div className='flex flex-col gap-[20px] items-center'>
                    <div className='mt-[20px] flex flex-col gap-[15px]'>
                        ...
                        <div className='flex gap-6 items-center justify-between'>
                            <lable className="">Photo File : </lable>
